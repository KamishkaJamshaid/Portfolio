    ...
    <section id="services" className="p-8  lg:m-0 bg-violet-900 shadow-inner shadow-violet-600">
      <div className="text-center text-white md:mt-20">
        ...
        <div className="m-12 mb-12 flex flex-wrap flex-cols-3 sm:felx-cols-3 lg:flex-cols-3 md:flex-cols-3 justify-center gap-6 md:gap-12">
          <div className="shadow-inner bg-white p-4 md:p-6 rounded-lg border-2 border-violet-800 hover:bg-violet-500 hover:text-white text-violet-800 w-full sm:w-80 md:w-80 shadow-lg shadow-purple-600 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300">
          ...
          <div className="bg-white border-2 border-violet-800 p-4 md:p-6 hover:bg-violet-500 hover:text-white rounded-lg text-violet-800 w-full sm:w-80 md:w-80 shadow-lg shadow-purple-600 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300 shadow-inner">
            <div className="flex justify-center items-center bg-violet-800 w-12 h-12 md:w-16 md:h-16 rounded-full mx-auto mb-4">
          ...
          <div className="bg-white p-4 md:p-6 border-2 hover:bg-violet-500 hover:text-white border-violet-800 rounded-lg text-violet-800 w-full sm:w-80 md:w-80 shadow-lg shadow-purple-600 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300">
            <div className="flex justify-center items-center bg-violet-800 w-12 h-12 md:w-16 md:h-16 rounded-full mx-auto mb-4">
          ...
          <div className="bg-white hover:bg-violet-500 hover:text-white p-4 md:p-6 border-2 border-violet-800 rounded-lg text-violet-800 w-full sm:w-80 md:w-80 shadow-lg shadow-purple-600 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300">
            <div className="flex justify-center items-center bg-violet-800 w-12 h-12 md:w-16 md:h-16 rounded-full mx-auto mb-4">
              <FaCogs className="text-2xl md:text-3xl text-white" />
            </div>
          ...
          <div className="hover:bg-violet-500 hover:text-white bg-white border-2 border-violet-800 p-4 md:p-6 rounded-lg text-violet-800 w-full sm:w-80 md:w-80 shadow-lg shadow-purple-600 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300">
            <div className="flex justify-center items-center bg-violet-800 w-12 h-12 md:w-16 md:h-16 rounded-full mx-auto mb-4">
              <FaPaintBrush className="text-2xl md:text-3xl text-white" />
            </div>
          ...
          <div className="hover:bg-violet-500 hover:text-white bg-white p-4 md:p-6 border-2 border-violet-800 rounded-lg text-violet-800 w-full sm:w-80 md:w-80 shadow-lg shadow-purple-600 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-300">
            <div className="flex justify-center items-center bg-violet-800 w-12 h-12 md:w-16 md:h-16 rounded-full mx-auto mb-4">
              <FaCogs className="text-2xl md:text-3xl text-white" />
            </div>
