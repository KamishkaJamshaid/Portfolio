...
const Header = () => {
  ...
  return (
    <div className="flex flex-cols-3 flex-wrap cursor-pointer items-center sticky top-0 z-50 bg-violet-950 p-4 lg:p-7 lg:p-7 justify-between h-20 lg:h-28">
      ...
      <header className="flex items-center ">
        ...
        <nav className={`${
          ...
          } lg:flex flex-col lg:flex-row lg:items-center bg-violet-950 lg:bg-transparent absolute lg:static border-2 lg:no-underline sm:underline lg:border-none top-full left-0 w-40 my-0 md:w-40 md:underline lg:w-auto space-y-2 lg:space-y-0 lg:space-x-4 mt-2 lg:mt-0 p-2 lg:p-0 text-white rounded-lg`}
        >
      ...
      <div className="flex space-x-4 lg:space-x-6 md:space-x-8 ml-4 lg:ml-0 items-center md:float-right lg:float-right">
        <a
